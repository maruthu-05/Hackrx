...
async def process_queries(
    ...
    try:
        ...
        # Step 3: Process each query with timeout protection
        answers = []
        for i, question in enumerate(request.questions):
            print(f"❓ Processing query {i+1}/{len(request.questions)}: {question[:50]}...")
            ...
            try:
                ...
                answers.append(f"Unable to process this question due to: {str(e)}")
